...
Looking at the data, there are definitely a few elements that seems to be either positively or negatively correlated. There is a correlation of 0.69 between white percentage and voter turnout. Then, on the opposing end, there is a negative correlation of -0.74 between voter turnout and unemployed percentage. Now, looking at the scatterplots below, the ones that have the biggest linear relationships between the group are also white percentage and unemployed percentage. 
...
Overall, the multiple variable model predicts turnout pretty well. Overall, there was a multiple r-squared of 0.8539 which tells me that between the independent variables there is definitely a lot of connection between the variation and the turnout. Next, the p-value of the model as a whole is 2.999e-06 indicating that this was not a coincidence, and shows that I can have full confidence in the data. Now, looking at the data itself, the independent variables that look to he significant are income, median age, and white percentage. 
...
The three alternative models that I am going to do will include removing the independent variables that did not have a correlation with the dependent variable. The first model difference is going to be taking away pct_bachelors_higher, which has the worst correlation within the bunch. The second difference is going to be taking away pct_bachelors_higher and population. Then, the last model is going to be taking away any variable with a p-value above 0.05. 
...
I would use this analysis to cover an election or voter participation story by focusing on the factors that had a correlation enough to be worth adding to a story about what affects voting turnout. The factors such as white percentage, median age and income had positive relationships with turnout directly, while other factors such as unemployment percentage, percentage of people with a bachelors degree or higher and population didn't affect voter turnout nearly as much, if not at all. 