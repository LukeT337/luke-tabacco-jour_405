...
gdp_data |> 
  ...
  geom_smooth(aes(x=GDP, y=DJIA), method="lm") +
    labs(title = "GDP and DJIA Scatterplot",
           x = "GDP",
           y = "DJIA")
...
The scatter plot shows that there is a strong positive correlation between GDP and DJIA. Looking a the plot, the data shows that there is definitely a mutual connection between the two pieces of data, as the two variables move in the same or similar direction. 
