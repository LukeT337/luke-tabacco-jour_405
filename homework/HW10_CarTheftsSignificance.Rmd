...
ANSWER: My initial reaction is that yes, from July 2023 to February 2025 there is definitely a decrease in car thefts. But, I am also questioning why there was a sudden increase around July 2024? 
...
ANSWER: The 95% confidence interval shows that the car thefts have definitely decreased since 2023. There is now a mean of 460.4 with a confidence interval that ranges from 415 to 505 respectively. 

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:**

ANSWER: The figures that actually reflect the number of car thefts in a typical month are the ones within the range of the mean and the margin of error. So, any number that falls between 415 and 505 accurately reflects the number of car thefts in a typical month. 
...
ANSWER: Car thefts in the area on the decline. 
...
ANSWER: I would definitely say that there is a difference between the two periods. 60 car thefts is a hefty number, and since the mean went from 490 to 430.8 that would seem pretty significant to me. So, yes we can reject the null hypothesis. 
...
ANSWER: I wouldn't revise my headline from task 6. I would tell my editor that there statistically evidence of a decline of car thefts in the area. And, if she does ask for statistical evidence, I can show her the test we just completed above! 
