...
In the data, we found that violent crime rates peaked in the 90s. We also found that property crime rates peaked in the late 70s into early 80s. Finally, the most recent data of violent and property crime rates in 2020 are significantly lower than they were in 1975 when the data was first available. This absolutely meets my expectation when looking at the pattern. It helps to ensure that our country has become safer over the last 45 years. 
