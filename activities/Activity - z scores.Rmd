...
ANSWER: Looking at the data, there are some days that have an abnormally large amount of calls. However, there are other days that have an abnomrally small amount of calls. The data really seems to fluctuate around. But, the mean of around 10 calls per day is pretty evidence on the graph, as most of the data seems to be around that mean amount. 
...
ANSWER: I feel like the data here doesn't differ from what I said in task three at all. In task three, I pretty much talked about how I felt most if not all of the data kind of sits around that mean mark of 10.44. there are 3822 calls of data that we got. If there are only 18 outliers that range unusually high or low of that 3822, that tells me it's really not that likely. 
...
ANSWER: Looking at the graph above, the weekend seems to have the highest amount of calls. Fridays see an average of 11 calls per day, Saturday sees 11.3 calls per day which is the highest amongst them all. Anf finally, Sunday sees an average of 10.8 calls per day. Every single one of these days have a higher average number of calls than any other day of the week.
...
ANSWER: From what I have found, there are two potential story angles that I would try and pitch. The first angle would be how the bulk of the calls come on the weekend, with the least amount of average calls coming during the week. Looking at the outlier days, or days with a really high/low z-score, the only day with a z-score higher than three was October 4, 2022. From what I found this isn't like a specific holiday. I would definitely look into why this date had such a high amount of calls. Finally, the last angle that I would potentially pitch would be how New Years day of 2023 had a high number of calls. That could be a cool story idea and something to look into, as the z-score for that day was 2.85. 
