...
**WRITE YOUR ANSWER HERE**: The results definitely suggests that there is a change in the trend of car thefts, but is there enough data to support that? The median pre spike rate sits at 22.17, heavily increasing in the spike year up to 58.13. Now, even thought that evidence does look appealing, there are 71 cars for the sample size of pre spike, and only 12 as a sample size of the spike year. Would this matter in terms of how serious you look at the data? 
...
2023 sees the highest rate of car thefts in the last eight years.

Car thefts rate the highest they've been in 2023 in Prince George's County going back to early 2017, according to the data. 
...
- **Null Hypothesis (H0)**: There is no statistical difference between the three rates across the different time periods of car thefts. 

- **Alternative Hypothesis (H1)**: There is a statistical difference between the different rates across the time periods of car thefts.
...
Yes, there are real differences in the average rates between the time periods. I know this because looking at the data, the F value is 218, which is very very high. This helps to indicate the accuray of our alternate hypothesis. Next, the P value is extremely low coming in at <2e-16, this also indicates that this test isn't just a coincidence. 
...
Headline: 2023 is the year of car thefts in Prince George's County

Lede: Car thefts were on the rise in 2023, spiking to the highest numbers and average over the last eight years. Since then, the rates continue to be higher than years prior, according to a recent data test.