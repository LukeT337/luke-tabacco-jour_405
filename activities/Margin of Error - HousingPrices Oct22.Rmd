...
1. Sample Size 100 -> 10
2. Sample Size 800 -> 3.536
3. Sample Size 400 -> 5
...
The headline "Majority Supports New City Policy" could be statistically justified, but it also could not. This all depends on the sample size that you use. For example, with a sample size of 100, there was 52% support with a margin of error of 10. This could mean that as high as 62% support, but also as low as 42% support which would be below majority. Sample idea falls in the sample size of 800. With 53% of people who support and a margin of error of 3.536, a low margin of error would also fall under 50%. The only sample size where you can't go below majority is with a sample size of 400. It led to 55% support with a margin of error of 5. So, at worst 50% support. An alternative headline that would be more accurate would have to be one that talks about it being around the 50% support, not that it's strictly majority. 
...
A new transit line is slowly increasing the property values of homes throughout the neighborhood.

Recent tests have showed how the new light rail line has increased the property values by almost seven percent, or 19 and a half thousand dollars, according to recent data from 14 recent home sales in the area. 