...
umd_fees_pct <- umd_fees |> 
  ...
  mutate(total_fees = rowSums(across(2:13))) |> 
...
In the data, I found that athletics, as well as recreation services were the highest throughout all the categories. But, the difference between the two is that athletics fees remained exactly the same from fall 2021 to fall 2024, while recreation services fees increased every year from fall 2021 to fall 2024. The story here could be finding out what might be the cause of the recreation service fees increase, compared to the stagnant fees of athletics?
