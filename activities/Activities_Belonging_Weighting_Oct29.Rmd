...
1. The first concern that raises a concern or a question to me relating to the impact of the results is the multiracial category. I don't understand why they would pair certain groups together and not others. It seems a little unfair. 
2. Relating to the same idea as my first concern, the results of the survey also grouped together individuals in a gender expansive category. This represented those who identified as non-binary, gender fluid, transgender, and other categories. This also seems unfair to those who are not accurately represented within the data, or represented with a different group of individuals. 
3. The last concern that we have is the representation of UMD students who actually participated in this survey. Only 20% of undergraduate students responded to the survey, and only 18% of graduate students answered the survey. 
...
ANSWER: The range of weights in this data span all the way from 0.2298, to as high as 3.0386. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:**

ANSWER: When a respondent has a weight of 0.23, that means this individual is extremely over represented. Vice versa, when a respondent has a weight of 3.04, that means this individual is extremely under represented within the data. 

3. Why might some respondents be weighted more heavily than others? **Write your answer here:**

ANSWER: There could be a lot of reasons why some respondents could be weighted more heavily than others. Some general factors could include race, gender, religion, career, education and a bunch more categories! But, it's really whatever information is being studied! 
...
ANSWER: The yes category shows the biggest difference between weighted and unweighted results. For the people that said they were planning on voting, the weight caused a -0.06% decrease. For the sporadic people that said they were voting in the next election, there was a -0.36% decrease. Finally, for the people that rarely vote who said they were voting in the next election, there was a -3.56% decrease after the weighted results. 

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:**

ANSWER: These differences might affect reporting on likely voter turnout because the weighted results will give a more realistic outlook on the true voting statistics. With the weight, reporters can truly see the voting statistics for those regardless of their voting history. 
...
ANSWER: I think these differences exist because looking at the individuals who say they never or rarely vote, but this time say they are going to, they might be over represented in the data. Same goes for the ones who say they are not going to vote when they always have in previous elections. So, these differences exist because there's always going to be individuals who are under or over represented in a data set. 
